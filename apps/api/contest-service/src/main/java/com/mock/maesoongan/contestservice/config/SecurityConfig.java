package com.mock.maesoongan.contestservice.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.mock.maesoongan.contestservice.auth.CurrentMember;
import com.mock.maesoongan.contestservice.common.ErrorResponse;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, BearerTokenFilter bearerTokenFilter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/contests/**").hasRole("USER")
    ...
    static class BearerTokenFilter extends OncePerRequestFilter {
        ...
        private void authenticate(CurrentMember currentMember) {
            authenticate(currentMember, List.of(new SimpleGrantedAuthority("ROLE_USER")));
        }
